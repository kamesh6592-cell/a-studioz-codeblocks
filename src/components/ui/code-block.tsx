      ...
      <div className="flex items-center justify-between px-4 py-2 bg-accent border-b border-border">
        ...
        <div className="flex gap-1">
          <button
            onClick={toggleWrap}
            className={cn(
              'p-1.5 rounded-md border border-border bg-background/80 backdrop-blur-sm shadow-sm transition-all duration-200 hover:shadow-md hover:scale-105',
              isWrapped ? 'text-primary border-primary/50 bg-primary/10' : 'text-muted-foreground hover:text-foreground hover:border-primary/30',
            )}
          ...
          <button
            ...
            className={cn(
              'p-1.5 rounded-md border border-border bg-background/80 backdrop-blur-sm shadow-sm transition-all duration-200 hover:shadow-md hover:scale-105',
              isCopied ? 'text-primary border-primary/50 bg-primary/10' : 'text-muted-foreground hover:text-foreground hover:border-primary/30',
            )}
